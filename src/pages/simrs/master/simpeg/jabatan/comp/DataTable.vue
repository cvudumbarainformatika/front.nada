<template>
  <div class="app-table f-12 full-height full-width column">
    <div class="col-auto q-px-md q-pt-md">
      ...
      <div class="flex items-center justify-between q-mb-md print-hide" :class="[]">
        ...
        <div class="col-one">
          ...
          <q-btn class="q-ml-sm" unelevated round color="primary" size="sm" icon="icon-mat-add"
            @click="store.modalFormOpen = true">
            <q-tooltip class="primary" :offset="[10, 10]">
              Data Baru
            </q-tooltip>
          </q-btn>
    ...
    <div class="col full-height">
      <q-markup-table ref="refCellTable" flat bordered class="rounded-xl shadow-sm full-height relative-position"
        :dense="$q.screen.lt.md" :class="[dark ? 'bg-dark' : 'bg-white']">

        <thead :class="dark ? 'bg-black' : 'bg-grey-4'">
          <tr>
                ...
                <td class="text-right">
                  <div class="row justify-end items-center">
                    ...
                    <div v-if="actionField">
                      ...
                      <q-btn v-if="selected?.length < 2 && adaDelete" flat class="" size="sm" round color="negative"
